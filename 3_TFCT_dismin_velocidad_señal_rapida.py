...
#----------------------------------------------------------
# 3. Interpolación para ralentizar (duplicar columnas)
...
new_time = np.linspace(0, n_frames - 1, n_frames_slow)
...
# 5. Guardar audio resultante
sf.write("picasso_rapida_lenta.wav", x_slow, fs)

# 6. Espectrograma en escala de grises
plt.figure(figsize=(10, 4))
librosa.display.specshow(librosa.amplitude_to_db(np.abs(X_slow), ref=np.max),
