...
# === CARGA DE AUDIO ===
#archivo = 'grabacionRapida.wav'
archivo = 'grabacion_rapida.wav'
...
n_fft = 512                    # Ventana corta para buena resolución en tiempo
hop_length = 128              # Salto moderado
...
librosa.display.specshow(D_db, sr=Fs, hop_length=hop_length,
